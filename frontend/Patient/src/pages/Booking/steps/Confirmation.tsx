        ...
        <div className="max-w-3xl mx-auto py-8">
            ...
            <div className="flex flex-col items-center text-center space-y-6 mb-16">
                ...
                <div className="space-y-2">
                    <h2 className="text-4xl font-display font-bold text-text italic">Booking Confirmed!</h2>
                    <p className="text-slate-400 font-medium">Your healing journey has been officially scheduled.</p>
                </div>
            </div>

            {/* Receipt Card */}
            <div className="bg-white rounded-[2.5rem] border-2 border-slate-100 shadow-2xl shadow-slate-200/50 overflow-hidden mb-12 animate-in slide-in-from-bottom-6 duration-700">
                <div className="bg-primary/5 p-8 border-b border-slate-100 flex justify-between items-center">
                    <div className="space-y-1">
                        ...
                        <p className="font-display font-bold text-text text-lg">#AYR-2026-9921</p>
                    </div>
                    <div className="flex gap-2">
                        <button className="p-2 bg-white rounded-xl border border-slate-100 text-slate-400 hover:text-primary transition-colors shadow-sm">
                            <Download size={18} />
                        </button>
                        <button className="p-2 bg-white rounded-xl border border-slate-100 text-slate-400 hover:text-primary transition-colors shadow-sm">
                            <Share2 size={18} />
                ...
                <div className="p-10 space-y-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div className="flex items-start gap-4">
                            <div className="w-12 h-12 bg-secondary/30 rounded-2xl flex items-center justify-center text-primary shrink-0 border border-primary/5">
                                <Calendar size={22} />
                            </div>
                            <div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Attendees</p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                <Button
                    ...
                    className="w-full sm:w-auto px-10 py-5 rounded-2xl bg-primary text-white shadow-xl shadow-primary/20 hover:bg-primary/90 flex items-center gap-2 font-bold"
                >
                    <Home size={18} />
                    Go to Dashboard
                </Button>
                <Button
                    ...
                    className="w-full sm:w-auto px-10 py-5 rounded-2xl border-slate-200 text-slate-600 hover:bg-slate-50 font-bold"
                >
